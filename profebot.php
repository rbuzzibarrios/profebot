...
// Never let PHP inject HTML-formatted warnings/notices into the response body —
// they corrupt JSON replies (client sees `<br /><font>...` and r.json() throws).
// Errors still go to the log (stderr → php -S console / Render dashboard).
